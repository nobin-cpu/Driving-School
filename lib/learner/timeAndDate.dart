...
class CreateLearnersTimeandDate extends StatefulWidget {
  String? instructorId, courseId, token, price;
  double? timeLimit;
  CreateLearnersTimeandDate(
      {Key? key,
      this.instructorId,
  ...
  @override
  State<CreateLearnersTimeandDate> createState() =>
      _CreateLearnersTimeandDateState();
}

class _CreateLearnersTimeandDateState extends State<CreateLearnersTimeandDate> {
  ...
  Future withdraw() async {
    ...
    request.fields.addAll({
      'booking_id': widget.courseId.toString(),
      'instructor_id': instIDS.toString(),
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          // Get.to(() => CreateLearnersTimeandDate2(
